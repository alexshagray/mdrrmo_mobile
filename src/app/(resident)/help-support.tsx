...
const EMERGENCY_SERVICES: HotlineItem[] = [
  ...
  },
  {
    ...
    agency: 'Health & Medical Services',
    number: '09268884321',
    icon: Stethoscope,
    color: '#10B981',
    ...
    <SafeAreaView className="flex-1 bg-[#0B1120]" edges={['top', 'bottom']}>
      ...
      <View className="flex-row items-center justify-between px-5 py-3 border-b border-slate-800/80 bg-[#0F172A]/90">
        ...
        <View className="items-center">
          <Text className="text-white text-base font-bold tracking-tight">Help & Support</Text>
      ...
      >
        ...
        <View className="mb-6">
          <View className="flex-row items-center justify-between mb-3 px-1">
            <View>
              <Text className="text-white font-bold text-base">Emergency Hotlines</Text>
              <Text className="text-slate-400 text-xs">Tap to call emergency responders immediately</Text>
            </View>
            <View className="bg-rose-500/20 border border-rose-500/30 px-2.5 py-1 rounded-full">
              <Text className="text-rose-400 text-[10px] font-extrabold uppercase">24/7 Hotlines</Text>
            </View>
          </View>
            ...
            {EMERGENCY_SERVICES.map((item) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  className="bg-[#0F172A]/90 border border-slate-800 rounded-3xl p-4.5 flex-row items-center justify-between shadow-lg active:bg-slate-850"
                  activeOpacity={0.7}
                >
                  <View className="flex-row items-center flex-1 mr-3">
                    <View
                      className={`w-11 h-11 rounded-2xl items-center justify-center border mr-3.5 ${item.badgeBg}`}
                    >
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="text-blue-400 font-mono text-xs font-bold mt-1">
                        {item.number}
                      </Text>
                    </View>
                  </View>

                  <View className="w-10 h-10 rounded-2xl bg-emerald-600/20 border border-emerald-500/30 items-center justify-center">
        ...
        <View className="bg-[#0F172A]/80 border border-slate-800 rounded-3xl p-5 mb-6 shadow-lg">
          ...
          <View className="space-y-3">
            <View className="flex-row items-start">
              <View className="w-6 h-6 rounded-full bg-blue-600/30 border border-blue-500/40 items-center justify-center mr-3 mt-0.5">
                <Text className="text-blue-400 text-xs font-bold">1</Text>
              </View>
              <View className="flex-1">
                <Text className="text-white font-bold text-xs">Submit Report</Text>
            ...
            <View className="flex-row items-start mt-3">
              ...
              <View className="flex-1">
                <Text className="text-white font-bold text-xs">Triage & Verification</Text>
                <Text className="text-slate-400 text-[11px] leading-relaxed mt-0.5">
            ...
            <View className="flex-row items-start mt-3">
              ...
              <View className="flex-1">
                <Text className="text-white font-bold text-xs">Ambulance Dispatch & Live Tracking</Text>
                <Text className="text-slate-400 text-[11px] leading-relaxed mt-0.5">
        ...
        <View className="bg-[#0F172A]/80 border border-slate-800 rounded-3xl p-5 mb-6 shadow-lg">
          <View className="flex-row items-center mb-4">
            ...
            <View>
              <Text className="text-white font-bold text-base">Frequently Asked Questions</Text>
              ...
              return (
                ...
                >
                  <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                  >
                    <Text className="text-white font-semibold text-xs flex-1 pr-3 leading-snug">
                      {faq.q}
                    </Text>
                    {isExpanded ? (
                  ...
                  {isExpanded ? (
                    <View className="px-4 pb-4 pt-1 border-t border-slate-800/60">
                      <Text className="text-slate-300 text-xs leading-relaxed">{faq.a}</Text>
                    </View>
                  ) : null}
                </View>
              );
        ...
        <View className="bg-[#0F172A]/80 border border-slate-800 rounded-3xl p-5 shadow-lg">
          <View className="flex-row items-center mb-3">
            <Building2 size={18} color="#3B82F6" className="mr-2" />
            <Text className="text-white font-bold text-sm">MDRRMO Opol Headquarters</Text>
          </View>
          <Text className="text-slate-300 text-xs leading-relaxed mb-2">
