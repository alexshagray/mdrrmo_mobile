...
export const ENV = {
  ...
  API_URL: process.env.EXPO_PUBLIC_API_URL || 'http://192.168.1.24:8000/api',

  
  // Reverb/Pusher Configuration
  REVERB_APP_KEY: process.env.EXPO_PUBLIC_REVERB_APP_KEY || 'local_reverb_key',
  REVERB_HOST: process.env.EXPO_PUBLIC_REVERB_HOST || '192.168.1.24',
